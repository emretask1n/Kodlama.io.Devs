package com.emretaskin.Kodlama.io.Devs.logger;
...
public class LoggingAspect {
    ...
    @Before("execution(* com.emretaskin.Kodlama.io.Devs.service.impl.*.*(..))")
    public void logMethodCall(JoinPoint joinPoint) {
        LOGGER.debug("Method {} is called with arguments {}", joinPoint.getSignature().getName(), joinPoint.getArgs());
    }

    @After("execution(* com.emretaskin.Kodlama.io.Devs.service.impl.*.*(..))")
    public void logMethodExit(JoinPoint joinPoint) {
        LOGGER.debug("Method {} is finished.", joinPoint.getSignature().getName());
    }

    @Around("execution(* com.emretaskin.Kodlama.io.Devs.service.impl.*.*(..))")
    ...
    @AfterReturning(pointcut = "execution(* com.emretaskin.Kodlama.io.Devs.service.impl.*.*(..))",
            returning = "result")
